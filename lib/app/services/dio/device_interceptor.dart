...
import 'package:zammacarsharing/app/services/dio/exceptions.dart';
import 'package:zammacarsharing/app/services/snackbar.dart';

class DeviceInterceptorsInterceptors extends Interceptor {
  bool isOverlayLoader;
  bool showSnakbar;

  DeviceInterceptorsInterceptors({this.isOverlayLoader = true, this.showSnakbar = true});
