...
class InsuranceVerificationView
    extends GetView<InsuranceVerificationController> {
  const InsuranceVerificationView({Key? key}) : super(key: key);
  @override
          ...
          child: Obx(()=>
              Column(crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    TextFieldDesign(hintText: "Enter insurance number",controller: controller.insuranceController.value),
