        ...
        child: SizedBox(
         ...
         Container(
            child: ListView.builder(
                  ...
                  return InkWell(onTap: (){
                    if(controller.rideHistory.value.data?[index]?.status=="inprogress") {
                      Get.toNamed(Routes.BOOKING, arguments: [
                        ...
                        (controller.rideHistory.value.data?[index]?.car?.model),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              "${controller.rideHistory.value.data?[index]?.car?.model} ${controller.rideHistory.value.data?[index]?.car?.brand}",
                              style: TextStyle(
                        ...
                        ListTile(
                            leading: Transform.translate(offset: Offset(-16,0),
                              child: Text(
                                "\$--/Hr",
                                style: TextStyle(
                                    fontWeight: FontWeight.bold, fontSize: 20.kh,color: ColorUtil.kPrimary),
                              ),
                            ),
                ...
                })):Center(child: Text("no_ride_history.svg")),
      ),
    );
  }
}
