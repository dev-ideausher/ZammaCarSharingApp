                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            EdgeInsets.fromLTRB(16.kh, 0, 0, 0),
                                        child: Text(
                                          "Pickup Location",
                                          style: GoogleFonts.urbanist(
                                              fontWeight: FontWeight.bold,
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            EdgeInsets.fromLTRB(0, 0, 16.kh, 0),
                                        child: Text(
                            ...
                            children: [
                              Column(
                                children: [
                                  ...
                                  Text(
                                    "${(controller.rideHistory.value.data?[controller.index]?.car?.mileage)}",
                                    style: GoogleFonts.urbanist(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 18.kh,
                                        color: ColorUtil.kPrimary),
                              ...
                              Column(
                                children: [
                                  ...
                                  Text(
                                    "${controller.durationOfRide.value} min",
                                    style: GoogleFonts.urbanist(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 18.kh,
                                        color: ColorUtil.kPrimary),
                                ...
                                children: [
                                  ...
                                  Obx(
                                    () => ListTile(
                                      ...
                                      title: Text(
                                          "XXXX XXXX XXXX-${(controller.carNumber).substring(15, 19)}",
                                          style: GoogleFonts.urbanist(
                                              fontWeight: FontWeight.w600,
                                              fontSize: 16.kh)),
                                      trailing: Switch(
